...
namespace Expo3.AdminApp.Tests
{
    ...
    public class EventServiceTests
    {
		...
		public void Setup()
		{
			...
			_eventService = _serviceProvider.GetService<EventService>();
		}
        ...
        public void AddSearchAndGetEventTest()
        {
	        ...
	        _eventService.AddEvent("TestEvent", "New", DateTime.MinValue, DateTime.MaxValue,
		        new Address {AddressString = "asd", City = "Ekaterinburg", Coordinates = new GeoCoordinate(12, 14)},
		        EEventType.Concert);

	        var searchedEvent = _eventService.SearchByName("Test").ToList();
	        ...
	        var gotEvent = _eventService.GetEvent(searchedEvent[0].Id);
