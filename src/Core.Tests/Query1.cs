...
{
	public abstract class BaseQuery1<T>
	{
		private readonly string _hash;

		protected BaseQuery1()
		{
	...
	public class Query1<T>
	{
		...
		public Query1<T> Bool(Func<BoolQuery1<T>, BoolQuery1<T>> query)
		{
			_counter = 0;
			query(new BoolQuery1<T>(this));
			return this;
		}
	...
	public class BoolQuery1<T>
	{
		private readonly Query1<T> _query;
		internal BoolQuery1(Query1<T> query)
		{
			_query = query;
		}

		public BoolQuery1<T> Must(string field, int value)
		{
			if (!_query.IsBuild)
			{
